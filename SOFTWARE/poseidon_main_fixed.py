...
class MainWindow(QtWidgets.QMainWindow, poseidon_controller_gui.Ui_MainWindow):
    ...
    def populate_syringe_sizes(self):
        self.syringe_options = ["NIPRO 2.5 mL", "NIPRO 5 mL", "NIPRO 10 mL", "NIPRO 20 mL", "NIPRO 30 mL", "NIPRO 50 mL"]
        self.syringe_volumes = [2.5, 5, 10, 20, 30, 50]
        self.syringe_areas = [96.76891, 141.02609, 201.06193, 346.36059, 452.38934, 646.92461]
    ...
    IMPORTANT: These are for NIPRO Plastic syringes ONLY!! Others will vary.
    '''
